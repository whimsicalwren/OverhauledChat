...
import dev.wren.overhauledchat.internal.config.ConfigModel
import dev.wren.overhauledchat.internal.config.ConfigModelCategory
import dev.wren.overhauledchat.internal.config.ConfigModelEntry
import dev.wren.overhauledchat.internal.config.ConfigType
...
object ConfigUpdater {
    ...
    private val serverConfig = buildConfigModel(OverhauledChatConfig.server)
    private val commonConfig = buildConfigModel(OverhauledChatConfig.common)
    private val clientConfig = buildConfigModel(OverhauledChatConfig.client)
